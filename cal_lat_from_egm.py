...
if __name__ == "__main__":
    ...
    anno_lat = electric.annotations.local_activation_time - electric.annotations.reference_activation_time
    ...
    interpolator_cal_lat = interpolators.LocalSMoothingInterpolator(
        points=electric.bipolar_egm.points,
        field=cal_lat
    )
